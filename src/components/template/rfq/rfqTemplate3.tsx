      ...
      >
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-cyan-400 to-cyan-500 transform origin-bottom-right">
          <div className="absolute bottom-0 right-0">
            ...
            >
              {logo || companyLogoUrl ? (
                <img src={logo || companyLogoUrl} alt="Logo" className="w-28 h-28 object-contain" />
              ) : (
        ...
        <div className="relative z-10 px-8 pt-32">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 mb-6">
              We are seeking proposals for <strong>printing services</strong> for the following materials. Please provide your best quote for the services listed below:
            </p>
          </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-purple-600 text-white">
                  <th className="px-4 py-3 text-left text-sm font-bold">Material</th>
                  <th className="px-4 py-3 text-center text-sm font-bold">Quantity</th>
                  <th className="px-4 py-3 text-center text-sm font-bold">Size</th>
                  <th className="px-4 py-3 text-center text-sm font-bold">Color</th>
                  <th className="px-4 py-3 text-center text-sm font-bold">Paper Type</th>
              ...
              <tbody>
                {data.items.map((item, index) => (
                  <tr key={index} className="border-b border-gray-300">
                    <td className="px-4 py-3 text-sm text-gray-800 font-semibold">{item.material}</td>
                    <td className="px-4 py-3 text-sm text-gray-800 text-center">{item.quantity}</td>
                    <td className="px-4 py-3 text-sm text-gray-800 text-center">{item.size}</td>
                    <td className="px-4 py-3 text-sm text-gray-800 text-center">{item.color}</td>
                    <td className="px-4 py-3 text-sm text-gray-800 text-center">{item.paperType}</td>
          ...
          <div className="mb-6">
            <p className="text-lg font-bold text-gray-800">
              Total Cost: <span className="text-purple-600">{data.totalCost}</span>
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
              <li>A description of your company's experience in providing printing services</li>
              <li>The turnaround time for each of the above materials</li>
              <li>The file formats accepted for printing</li>
              <li>Any additional services, such as design and proofreading, that your company can provide.</li>
