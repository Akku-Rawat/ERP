      ...
      >
        ...
        <div className="px-15">
          ...
          <div className="grid grid-cols-4 gap-6 mb-8">
            ...
            {/* SHIP TO */}
            <div>
              <h3 className="text-xs font-bold text-gray-400 uppercase mb-2">SHIP TO</h3>
              <div className="text-sm space-y-1">
                <p className="font-semibold text-gray-800">{data.CutomerName}</p>
            ...
            <div className="text-right">
              <h3 className="text-xs font-bold text-gray-400 uppercase mb-2">INVOICE TOTAL</h3>
          ...
          <div className="border-t border-gray-300 pt-6 space-y-4 pb-8">
            <div>
              ...
              <p className="text-sm text-gray-700">{data.termsAndConditions || "Payment is due within 15 days"}</p>
            </div>
