...
const InvoiceModal: React.FC<InvoiceModalProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleFormChange = (
    ...
    const numValue = ['salesCommission', 'exciseDuty', 'totalDiscount', 'totalTax', 'adjustment'].includes(name) ? Number(value) : value;
          ...
          <form className="pb-2 bg-[#fefefe]/10 flex flex-col flex-1 overflow-hidden" onSubmit={handleSave}>
            ...
            <div className="flex-1 overflow-y-auto border-b">
              ...
              <div className="border m-4 p-6 flex flex-col gap-y-2">
                <div className="font-semibold text-gray-600 mb-4">INVOICE INFORMATION</div>
                <div className="grid grid-cols-4 gap-4 mb-6">
                  <input className="col-span-1 border rounded p-2" placeholder="Invoice Owner" name="invoiceOwner" value={form.invoiceOwner} onChange={handleFormChange} />
                  ...
                  <input className="col-span-1 border rounded p-2" type="date" placeholder="Invoice Date" name="invoiceDate" value={form.invoiceDate} onChange={handleFormChange} />
                  ...
                  <input className="col-span-1 border rounded p-2" placeholder="Sales Order" name="salesOrder" value={form.salesOrder} onChange={handleFormChange} />
                  <input className="col-span-1 border rounded p-2" placeholder="Purchase Order" name="purchaseOrder" value={form.purchaseOrder} onChange={handleFormChange} />
              ...
              {/* INVOICED ITEMS */}
              <div className="border m-4 p-6 flex flex-col gap-y-2">
                <div className="font-semibold text-gray-600 mb-2">INVOICED ITEMS</div>
                      ...
                      {items.map((itemRow, idx) => {
                        ...
                        return (
                          <tr key={idx}>
                            ...
                            <td>
                              <input type="number" className="border rounded p-1 w-full" name="discount" value={itemRow.discount} onChange={e => handleItemChange(e
...
, idx)} />
              ...
              {/* SUMMARY SECTION */}
              <div className="border m-4 p-6 flex flex-col gap-y-2">
                <div className="font-semibold text-gray-600 mb-2">SUMMARY SECTION</div>
                <div className="grid grid-cols-5 gap-4 mb-6">
