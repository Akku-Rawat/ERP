      ...
      <div className="max-w-full">
              ...
              <div className="space-y-2">
                <button
                  ...
                  style={{
                    ...
                    background: selectedType === 'logo' ? 'var(--primary-600)' : undefined,
                    color: selectedType === 'logo' ? 'var(--table-head-text)' : undefined
                  }}
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-3">
                      <div
                        ...
                        style={{ background: selectedType === 'logo' ? 'rgba(255,255,255,0.12)' : 'var(--primary-100)' }}
                      >
                        <FaImage className="w-5 h-5" style={{ color: selectedType === 'logo' ? 'white' : 'var(--primary-700)' }} />
                      </div>
                      <div>
                        <p className="font-semibold" style={{ color: selectedType === 'logo' ? 'white' : undefined }}>Company Logo</p>
                        <p className="text-xs" style={{ color: selectedType === 'logo' ? 'rgba(255,255,255,0.85)' : undefined }}>PNG, JPG, SVG</p>
                      </div>
                    </div>
                    {logo && (
                ...
                <button
                  ...
                  style={{
                    ...
                    color: selectedType === 'signature' ? 'var(--table-head-text)' : undefined
                  }}
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-10 h-10 rounded-lg flex items-center justify-center"
                        style={{ background: selectedType === 'signature' ? 'rgba(255,255,255,0.12)' : 'var(--primary-100)' }}
                      >
                        <FaFileSignature className="w-5 h-5" style={{ color: selectedType === 'signature' ? 'white' : 'var(--primary-700)' }} />
                      </div>
                      <div>
                        <p className="font-semibold" style={{ color: selectedType === 'signature' ? 'white' : undefined }}>Authorized Signature</p>
                        <p className="text-xs" style={{ color: selectedType === 'signature' ? 'rgba(255,255,255,0.85)' : undefined }}>PNG, JPG, SVG</p>
                      </div>
                    </div>
                    {signature && (
                      <span className="text-xs badge-success px-2 py-1 rounded-full font-medium flex items-center gap-1">
              ...
              <div className="mt-6 pt-4 border-t border-theme">
                ...
                <ul className="space-y-2">
                  <li className="text-xs flex items-start gap-2">
                    <span style={{ color: 'var(--primary-700)', fontWeight: 700, marginTop: 2 }}>•</span>
              ...
              {isUploading ? (
                ...
                <div className="p-12 text-center">
                  ...
                  <div className="max-w-md mx-auto space-y-2">
                    ...
                    <p className="text-sm font-semibold" style={{ color: 'var(--primary-700)' }}>{progress}% Complete</p>
                  </div>
                </div>
              ) : !currentFile ? (
                // Upload Zone
                <div
                  ...
                  style={{
                    borderColor: dragActive === selectedType ? 'var(--primary-700)' : undefined,
                    background: dragActive === selectedType ? 'var(--row-hover)' : undefined,
        ...
        <div className="mt-6 flex justify-end gap-4">
          ...
          <button
            ...
            style={logo || signature ? { background: 'var(--primary)' } : undefined}
          >
            Save Documents
          </button>
        </div>
