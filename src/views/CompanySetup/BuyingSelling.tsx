...
import { FaShoppingCart, FaChartLine, FaCheckCircle } from "react-icons/fa";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-2">
                These terms will be applied to all purchase orders by default
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            ...
            <div>
              ...
              />
              <p className="text-xs text-slate-500 mt-2">
                These terms will be applied to all sales orders by default
              </p>
            </div>
          </div>
        </div>
