...
const KPIChange: React.FC<KPIChangeProps> = ({ change }) => (
  <span
    className={`ml-2 text-[16px] font-semibold ${change > 0 ? "text-green-600" : change < 0 ? "text-red-600" : "text-gray-600"}`}
  >
...
const CRMDashboard: React.FC = () => {
  const [selectedRange, setSelectedRange] =
    React.useState<TrendRangeType>("This Month");
        ...
        <div className="flex gap-8 mb-8">
          ...
          <div className="w-[40%] min-w-[260px]">
            <div className="bg-white rounded-xl shadow p-8 h-full flex flex-col items-center justify-start">
              <div
                className="font-semibold text-2xl mb-4 mt-0"
