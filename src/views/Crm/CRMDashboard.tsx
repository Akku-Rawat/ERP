              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                ...
                <div className="w-full bg-blue-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${(ticketStats.open / ticketStats.total) * 100}%`,
                    }}
                  />
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-4 border border-yellow-100">
                ...
                <div className="w-full bg-orange-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${(ticketStats.inProgress / ticketStats.total) * 100}%`,
                    }}
                  />
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-100">
                ...
                <div className="w-full bg-green-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${(ticketStats.resolved / ticketStats.total) * 100}%`,
                    }}
                  />
                </div>
              </div>
          ...
          <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Your most valuable deals in the pipeline
                </p>
              </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {topOpportunities.map((op, idx) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-3 py-1.5 inline-flex text-xs leading-5 font-bold rounded-lg ${
                          op.stage.includes("Won")
                            ? "bg-gradient-to-r from-green-400 to-green-600 text-white shadow-md"
                            : op.stage.includes("Negotiation")
                              ? "bg-gradient-to-r from-blue-400 to-blue-600 text-white shadow-md"
                              : op.stage.includes("Proposal")
                                ? "bg-gradient-to-r from-purple-400 to-purple-600 text-white shadow-md"
                                : op.stage.includes("Demo")
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        {new Date(op.expectedClose).toLocaleDateString(
                          "en-IN",
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      <button
                        onClick={() =>
                          setShowActions(
                            showActions === op.name ? null : op.name,
                          )
                        }
