...
const Payroll: React.FC = () => {
  const [payrollRecords, setPayrollRecords] =
    useState<PayrollRecord[]>(demoPayrollRecords);
  const [selectedDept, setSelectedDept] = useState("All Departments");
  const [filterStatus, setFilterStatus] = useState<
    "All" | "Paid" | "Pending" | "Processing" | "Failed"
  >("All");
...
Generated on: ${new Date().toLocaleString()}
  ...
  const handleEmailPayslip = () => {
    if (!selectedEmployee) return;
    alert(
      `Payslip sent to ${selectedEmployee.employeeName}'s registered email address!`,
    );
  };
                  ...
                  <div className="bg-red-50 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-slate-800">
                          ₹{selectedEmployee.taxDeduction.toLocaleString()}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-600">PF Deduction</span>
                        <span className="font-semibold text-slate-800">
                          ₹{selectedEmployee.pfDeduction.toLocaleString()}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-600">Other Deductions</span>
                        <span className="font-semibold text-slate-800">
                          ₹{selectedEmployee.otherDeductions.toLocaleString()}
                        </span>
                      </div>
                      <div className="flex justify-between pt-3 border-t-2 border-red-200">
                        ...
                        <span className="font-bold text-red-800">
                          ₹
                          {(
                            selectedEmployee.taxDeduction +
                            selectedEmployee.pfDeduction +
                            selectedEmployee.otherDeductions
                          ).toLocaleString()}
                        </span>
                      </div>
                    </div>
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl">
              ...
              <div className="bg-gradient-to-r from-teal-500 to-teal-600 text-white p-6 rounded-t-2xl">
                ...
                <p className="text-teal-100 mt-1">
                  Review details before processing
                </p>
              </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700">
                      ...
                      "Pending" status. Please ensure sufficient funds are
                      available in the payroll account.
                    </p>
                  </div>
                </div>
