...
const demoJobOpenings: JobOpening[] = [
  ...
  { id: 'J004', jobTitle: 'HR Manager', department: 'HR', type: 'Full-Time', postingDate: '02/28/2024', candidates: 12, status: 'Open' },
];

const demoCandidates: Candidate[] = [
  { id: 'C001', name: 'Alice Johnson', position: 'Software Engineer', appliedDate: '03/20/2024', stage: 'Interview', email: 'alice@email.com' },
  { id: 'C002', name: 'Bob Smith', position: 'Marketing Coordinator', appliedDate: '03/18/2024', stage: 'Shortlisted', email: 'bob@email.com' },
  { id: 'C003', name: 'Carol Davis', position: 'Software Engineer', appliedDate: '03/17/2024', stage: 'Offer', email: 'carol@email.com' },
  { id: 'C004', name: 'David Wilson', position: 'Sales Associate', appliedDate: '03/16/2024', stage: 'Hired', email: 'david@email.com' },
  { id: 'C005', name: 'Emma Brown', position: 'Software Engineer', appliedDate: '03/15/2024', stage: 'Applied', email: 'emma@email.com' },
  { id: 'C006', name: 'Frank Miller', position: 'HR Manager', appliedDate: '03/14/2024', stage: 'Interview', email: 'frank@email.com' },
];

const demoNewHires: NewHire[] = [
  { id: 'H001', name: 'David Wilson', position: 'Sales Associate', department: 'Sales', startDate: '04/01/2024', status: 'In Progress', tasksCompleted: 6, totalTasks: 10 },
  { id: 'H002', name: 'Carol Davis', position: 'Software Engineer', department: 'Engineering', startDate: '03/25/2024', status: 'Completed', tasksCompleted: 10, totalTasks: 10 },
  { id: 'H003', name: 'Frank Miller', position: 'HR Manager', department: 'HR', startDate: '04/05/2024', status: 'Pending', tasksCompleted: 0, totalTasks: 10 },
];

const demoExitEmployees: ExitEmployee[] = [
  { id: 'E001', name: 'John Doe', position: 'Senior Developer', department: 'Engineering', exitDate: '04/15/2024', reason: 'Resignation', status: 'In Progress', tasksCompleted: 5, totalTasks: 8 },
  { id: 'E002', name: 'Sarah Johnson', position: 'Marketing Manager', department: 'Marketing', exitDate: '04/20/2024', reason: 'Relocation', status: 'Pending', tasksCompleted: 0, totalTasks: 8 },
  { id: 'E003', name: 'Mike Chen', position: 'Finance Analyst', department: 'Finance', exitDate: '03/31/2024', reason: 'Resignation', status: 'Completed', tasksCompleted: 8, totalTasks: 8 },
];
...
const Recruitment: React.FC = () => {
  const [mainTab, setMainTab] = useState<'recruitment' | 'onboarding' | 'offboarding'>('recruitment');
  const [recruitmentSubTab, setRecruitmentSubTab] = useState<'openings' | 'candidates'>('openings');
