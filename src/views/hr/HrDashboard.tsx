  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        {/* Headcount */}
        <div
          className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 lg:p-6 hover:shadow-md transition cursor-pointer"
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 lg:p-6 hover:shadow-md transition">
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="px-2 py-1 bg-orange-100 text-orange-700 text-[10px] lg:text-xs font-semibold rounded">
              URGENT
            </span>
          </div>
          <p className="text-2xl lg:text-3xl font-bold text-gray-800 mb-1">
            {kpiData.pendingActions.total}
          </p>
        ...
        >
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="text-xs lg:text-sm text-gray-500">
              {kpiData.payroll.status}%
            </span>
          </div>
          <p className="text-2xl lg:text-3xl font-bold text-gray-800 mb-1">
            ₹{(kpiData.payroll.amount / 1000).toFixed(0)}K
          </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs lg:text-sm text-gray-600">
                {kpiData.pendingActions.leaves} leave requests,{" "}
                {kpiData.pendingActions.payroll} payroll items,{" "}
                {kpiData.pendingActions.recruitment} recruitment tasks
              </p>
            </div>
          </div>
          <button
        ...
        {quickStats.map((stat, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-1 text-[10px] lg:text-xs">
              <span
                className={`font-semibold ${stat.trend === "down" && (stat.label.includes("Turnover") || stat.label.includes("Time")) ? "text-green-600" : stat.trend === "up" ? "text-green-600" : "text-red-600"}`}
              >
                {stat.change}
              </span>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-xs lg:text-sm text-gray-500">
                Monthly trend with hires & exits
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span
                      className={`px-2 py-0.5 rounded text-[9px] lg:text-[10px] font-bold whitespace-nowrap ${
                        item.type === "urgent"
                  ...
                  <p className="font-medium text-gray-800 text-xs lg:text-sm truncate">
                    {item.message}
                  </p>
                </div>
              </div>
