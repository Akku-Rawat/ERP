...
import { Search, Plus, User, Edit2, Trash2, ChevronDown, X, Upload } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="bg-white p-6 rounded-sm border border-gray-200">
                    <p className="text-xs text-gray-500 mb-4">Set a manager for reports to show in org chart</p>
                    
                    {/* Manager Selection */}
                    <div className="mb-6">
                      <label className="block text-xs text-gray-600 mb-2 font-medium">Manager</label>
                      <select
                      ...
                      >
                        ...
                        <option value="Sarah Wilson">Sarah Wilson (Marketing Lead)</option>
                        <option value="Jane Doe">Jane Doe (HR Manager)</option>
                        <option value="Yaint Smith">Yaint Smith (Sales Manager)</option>
                        <option value="Mike Johnson">Mike Johnson (Accountant)</option>
                      </select>
                    </div>
                      ...
                      {formData.manager ? (
                        <>
                          <div className="bg-blue-50 rounded p-3 border border-blue-200">
                            <div className="text-xs font-medium text-blue-900">{formData.manager}</div>
                            <div className="text-xs text-blue-600 mt-1">Manager</div>
                          </div>
