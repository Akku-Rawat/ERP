                ...
                <div className="px-6 pb-6 relative">
                  ...
                  <div className="bg-background rounded-lg p-3 mb-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-bold text-main font-mono">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
                    <p className="text-xs text-green-700 dark:text-green-400 font-bold uppercase tracking-wide mb-1">
                      Gross Salary
                    </p>
                    <p className="text-2xl font-bold text-green-900 dark:text-green-100">
                      {payrollInfo.currency}{" "}
                      {Number(payrollInfo.grossSalary).toLocaleString()}
                    </p>
              ...
              >
                ...
                <div className="bg-background rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <DeductionRow
                      label="PAYE"
                      value={`${payrollInfo.currency} ${Number(payrollInfo.statutoryDeductions.payeAmount).toLocaleString()}`}
                    />
                  </div>
                </div>
              </CollapsibleSection>
                ...
                <div className="grid grid-cols-1 gap-3">
                  {documents.map((doc) => {
                    return (
                      <div
                        key={doc.id}
                        className="group flex items-center justify-between p-4 border rounded-xl"
                      >
...
const CompactField = ({ label, value }: any) => (
  <div className="flex justify-between items-center py-2">
    ...
    <span className="text-sm font-bold text-main text-right">
      {value || "—"}
    </span>
  </div>
);
