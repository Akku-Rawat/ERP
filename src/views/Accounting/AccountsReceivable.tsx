                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1">
                      ...
                      >
                        {Math.abs(invoice.days)} days{" "}
                        {invoice.overdue ? "overdue" : "left"}
                      </span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${getStatusColor(invoice.status)}`}
                    >
                      {invoice.status}
                    </span>
                  </td>
