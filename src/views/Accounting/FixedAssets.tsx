...
const FixedAssets = () => {
  ...
  // Sample Data
  const stats = [
    { label: 'Total Asset Value', value: '₹45,00,000', change: '+5%', trend: 'up', color: 'indigo' },
    { label: 'Monthly Depreciation', value: '₹75,000', change: '0%', trend: 'neutral', color: 'yellow' },
    { label: 'Active Assets', value: '156', change: '+8', trend: 'up', color: 'green' },
    { label: 'In Maintenance', value: '12', change: '-3', trend: 'down', color: 'orange' }
  ];

  const assets = [
    { id: 'FA-001', name: 'Desktop Computers', category: 'IT Equipment', value: 450000, depreciation: 15000, location: 'Office Floor 1', condition: 'Good', purchaseDate: '2023-01-15' },
    { id: 'FA-002', name: 'Office Furniture', category: 'Furniture', value: 250000, depreciation: 5000, location: 'Office Floor 2', condition: 'Excellent', purchaseDate: '2023-06-10' },
    { id: 'FA-003', name: 'Server Equipment', category: 'IT Equipment', value: 850000, depreciation: 35000, location: 'Data Center', condition: 'Good', purchaseDate: '2022-11-20' },
    { id: 'FA-004', name: 'Vehicles', category: 'Transportation', value: 1200000, depreciation: 40000, location: 'Parking Lot', condition: 'Fair', purchaseDate: '2022-05-05' },
    { id: 'FA-005', name: 'Manufacturing Equipment', category: 'Machinery', value: 2500000, depreciation: 85000, location: 'Factory Floor', condition: 'Good', purchaseDate: '2021-09-15' },
    { id: 'FA-006', name: 'Conference Room Tech', category: 'IT Equipment', value: 180000, depreciation: 8000, location: 'Conference Room A', condition: 'Excellent', purchaseDate: '2023-03-22' },
  ];
  ...
  const categories = ['all', 'IT Equipment', 'Furniture', 'Transportation', 'Machinery'];
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-gray-700 font-medium capitalize">{filterCategory}</span>
              </button>
                  ...
                  {categories.map(category => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 hover:bg-gray-50 capitalize ${
                        filterCategory === category ? 'bg-indigo-50 text-indigo-700 font-medium' : 'text-gray-700'
                      }`}
                    >
                      {category}
                    </button>
              ...
              {filteredAssets.map((asset) => (
                <tr key={asset.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4">
                    <span className="text-sm font-mono font-medium text-indigo-600">{asset.id}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm font-medium text-gray-900">{asset.name}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span className="text-sm text-gray-700">{asset.category}</span>
                  </td>
                  <td className="px-6 py-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              { name: 'Transportation', value: 1200000, count: 1, color: 'green' },
              ...
              <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{cat.count} asset{cat.count !== 1 ? 's' : ''}</p>
                  </div>
                </div>
                <p className="text-sm font-semibold text-gray-900">₹{(cat.value / 100000).toFixed(1)}L</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Depreciation Schedule (Next 12 Months)</h3>
          <div className="space-y-3">
            {[
